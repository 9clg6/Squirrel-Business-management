...
class _EditOrAddOrderDialogState extends ConsumerState<EditOrAddOrderDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.watch(businessTypeServiceProvider);
    ...
    return Dialog(
      child: Container(
        ...
        width: 600,
        child: switch (state) {
          AsyncData(value: BusinessTypeState()) => SingleChildScrollView(
              child: Form(
                key: formKey,
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: validator(state.value.isService
                          ? LocaleKeys.shop.tr()
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            validator:
                                validator(LocaleKeys.orderDate.tr(), true),
                          ),
                        ),
                        const Gap(16),
                        Expanded(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                validator:
                                    validator(LocaleKeys.internalFees.tr()),
                                keyboardType: TextInputType.number,
                                inputFormatters: [
                                  FilteringTextInputFormatter.digitsOnly,
                                ],
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            final price = double.tryParse(orderAmountController
                                    .text
                                    .replaceAll(' €', '')) ??
                                order?.price;
